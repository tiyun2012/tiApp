# === install-final.ps1 ===
# Robust Installer v3 (using String Arrays to prevent syntax errors)

$Root = Join-Path $PSScriptRoot "tiApp"
Write-Host "🔷 Installing Ti3D v3 (Safe Mode)..." -ForegroundColor Cyan
...
# --- 2. PUBLIC HTML ---
# Using strict quotes to avoid <svg> syntax errors

Write-SafeFile "public\index.html" @(
    "<!doctype html>",
    "<html lang='en'>",
    "<head>",
    "  <meta charset='utf-8' />",
...
Write-SafeFile "src\services\EventBus.js" @("export const eventBus = new EventTarget(); export default eventBus;")

Write-SafeFile "src\services\RendererService.js" @(
...
Write-SafeFile "src\services\SceneService.js" @(
    "import * as THREE from 'three';",
...
Write-SafeFile "src\services\HistoryService.js" @(
...
Write-SafeFile "src\services\ControlsService.js" @(
    "import * as THREE from 'three';",
...
Write-SafeFile "src\services\PickingService.js" @(
    "import * as THREE from 'three';",
...
Write-SafeFile "src\modules\outliner\index.js" @(
    "import eventBus from '../../services/EventBus.js';",
...
Write-SafeFile "src\modules\outliner\outliner.css" @(
...
Write-SafeFile "src\modules\chip-editor\index.js" @(
...
Write-SafeFile "src\modules\chip-editor\chip-editor.css" @(".chip-window .window-content { background:#151515; }")

Write-SafeFile "src\ui\ContextMenu.js" @(
...
Write-SafeFile "src\ui\ContextMenu.css" @(
...
Write-SafeFile "src\ui\Window.js" @(
...
Write-SafeFile "src\utils\serializer.js" @(
...
Write-Host "------------------------------------------------"
Write-Host "🎉 Ti3D Installed Successfully!" -ForegroundColor Cyan
Write-Host "   Run 'runApp.bat' inside tiApp."
Write-Host "------------------------------------------------"